...
import IParkingLotRepository from "../../core/repository/IParkingLotRepository";

export default class ParkingLotRepositoryMemory implements IParkingLotRepository {
  parkingLots = [
   { 
     code: 'shopping',
     capacity: 5, 
